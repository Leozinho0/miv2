...
if(isset($_GET['pc_load'])){
	switch ($_GET['pc_load']) {
		...
		{
			echo '<div class="pc_ms_left"><h3>Inserir Dados</h3><h4><a href="" >'.$_SESSION['conn']['127.0.0.1']['address'] . '</a> ' . ' > ' . '<a href=""> '. $_GET['database'] . '</a>' . ' > ' . '<a href="">' . $_GET['table'] .'</a></h4>
							<div class="pc_ms_left_listTables">
								<div>
									Tabela 1 <a href=""><img src="img/pmahomme/img/b_drop.png" alt=""></a> <a href=""><img src="img/pmahomme/img/b_edit.png" alt=""></a> 
								</div>
								<div>
									Tabela 2 <a href=""><img src="img/pmahomme/img/b_drop.png" alt=""></a> <a href=""><img src="img/pmahomme/img/b_edit.png" alt=""></a> 
								</div>
								<div>
									Tabela 3 <a href=""><img src="img/pmahomme/img/b_drop.png" alt=""></a> <a href=""><img src="img/pmahomme/img/b_edit.png" alt=""></a> 
								</div>
							</div>
							<div>
